...
class SeasonsDatatable extends DataTable
{
     ...
     *
     * @param \App\Models\Seasons $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Seasons $model)
    {
        return $model->with(['series'])->newQuery();
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('season_number'),
            Column::make('series.title')->title('Series'),
            [
                'name' => 'action',
                'data' => 'action',
                'title' => 'Action',
