...
class LikesDatatable extends DataTable
{
     ...
     *
     * @param \App\Models\Likes $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Likes $model)
    {
        return $model->with(['user', 'movie', 'episode'])->newQuery();
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('like')->title('like'),
            Column::make('user.name')->title('User'),
            Column::make('movie.title')->title('Movie'),
            Column::make('episode.title')->title('Episode'),
            [
                'name' => 'action',
                'data' => 'action',
                'title' => 'Action',
