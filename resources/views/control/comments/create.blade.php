...
<div class="card text-left">
    <div class="card-header">
        <h3 class="card-title">Creat A Comments</h3>
    </div>
    <div class="card-body">
    @if ($errors->all())
	...
	{{ Form::open(array('url' => '/control/comments', 'method' => 'POST')) }}
		...
		<div class="col-sm-10">
			{{ Form::select('status', array('0' => 'Not active', '1' => 'Active'),null, ['class' => 'form-control'])  }}
		</div>
		</div>
	    ...
	    <div class="col-sm-10">
			{{ Form::select('article_id', App\Models\Articles::pluck('title', 'id'),null, ['class' => 'form-control'])  }}
	    </div>
		</div>
