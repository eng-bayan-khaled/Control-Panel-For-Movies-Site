...
<div class="card text-left">
    <div class="card-header">
        <h3 class="card-title">Edit Of Likes</h3>
    </div>
    <div class="card-body">
    @if ($errors->all())
	...
	{{ Form::open(array('url' =>  '/control/likes/'.$like->id, 'method' => 'put')) }}

		<div class="form-group row">
		{{ Form::label('like', 'Like', ['class' => 'col-sm-2 col-form-label'])  }}
		<div class="col-sm-10">
			{{ Form::select('like', array('0' => 'Dislike', '1' => 'Like'),$like->like, ['class' => 'form-control'])  }}
		</div>
		</div>
	    ...
	    <div class="col-sm-10">
			{{ Form::select('user_id', App\Models\Users::pluck('name', 'id'),$like->user_id, ['class' => 'form-control'])  }}
	    </div>
		</div>
	    ...
	    <div class="col-sm-10">
			{{ Form::select('movie_id', App\Models\Movies::pluck('title', 'id'),$like->movie_id, ['class' => 'form-control'])  }}
	    </div>
		</div>
	    ...
	    <div class="col-sm-10">
			{{ Form::select('episode_id', App\Models\Episodes::pluck('title', 'id'),$like->episode_id, ['class' => 'form-control'])  }}
	    </div>
		</div>
