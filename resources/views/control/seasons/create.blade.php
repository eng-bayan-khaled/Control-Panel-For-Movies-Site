...
<div class="card text-left">
    <div class="card-header">
        <h3 class="card-title">Creat A Seasons</h3>
    </div>
    <div class="card-body">
    @if ($errors->all())
	...
	{{ Form::open(array('url' => '/control/seasons', 'method' => 'POST')) }}
		...
		<div class="col-sm-10">
		{{ Form::text('season_number',$value = null, ['class' => 'form-control'])  }}
		</div>
		</div>
	    ...
	    <div class="col-sm-10">
			{{ Form::select('series_id', App\Models\Series::pluck('title', 'id'),null, ['class' => 'form-control'])  }}
	    </div>
		</div>
